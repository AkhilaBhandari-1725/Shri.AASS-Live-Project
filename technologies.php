		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-12 banner-right">
					<h1 class="text-white">
							Technologies<br> here..
					</h1>
					<p class="mx-auto text-white  mt-20 mb-40">
						There is probably no greater leap forward than building up ypur career.
					</p>
					<div class="link-nav">
						<span class="box">
...
?>
 ...
 <center><h3>Image Gallery</h3></center>
  <?php
  $s="select * from Our_technologies";
  $arr=mysqli_query($con,$s);
  
  while($ar=mysqli_fetch_array($arr))
  {
  	  echo "<img src='$ar[2]' width='400' height='400' hspace='30' vspace='50'>";
